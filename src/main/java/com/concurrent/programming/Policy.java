...
public class Policy {
     ...
     */
    private final QueueMonitorManagment queue;
    /**
     ...
     */
    public Policy(QueueMonitorManagment queueManagement, policyType mode, policyType modeSec,
                  PolicyStaticRAW staticPolicy) throws ConfigException {
        super();
        ...
        if (staticPolicy == null || staticPolicy.getMatrixT() == null)
            ...
            new CheckPolicy(staticPolicy, size); // >> ConfigException
    ...
    int[] firstOnTrue(int[] priorVector) {
     ...
     */
    int[] matMulVect(int[] v, int[][] m, boolean transpuesta) throws ArithmeticException {
     ...
     */
    private void matReaorderRandom(int[][] matrix) throws ArithmeticException {
